    ...
    require("vgit").setup {
      keymaps = {
        ...
        },
        {
          mode = "n",
          key = "<leader>gS",
          handler = "buffer_stage",
          desc = "Stage entire buffer",
        },
        {
          mode = "n",
          key = "<leader>gU",
          handler = "buffer_unstage",
        ...
        -- Conflict Resolution
        {
          ...
          desc = "Accept both conflict changes",
        },
        {
          mode = "n",
          key = "<leader>gcc",
          handler = "buffer_conflict_accept_current",
          desc = "Accept current conflict changes",
        },
        {
          mode = "n",
          key = "<leader>gci",
          handler = "buffer_conflict_accept_incoming",
          desc = "Accept incoming conflict changes",
        },
        ...
        -- Project-wide Operations
        {
          ...
          desc = "Project-wide diff preview",
        },
        {
          mode = "n",
          key = "<leader>gl",
          handler = "project_logs_preview",
          desc = "Project logs preview",
        },
        {
          mode = "n",
          key = "<leader>gc",
          handler = "project_commit_preview",
          desc = "Commit preview",
        },
        {
          mode = "n",
          key = "<leader>gC",
          handler = "project_commits_preview",
          desc = "Project commits preview",
        },
        {
          mode = "n",
          key = "<leader>gX",
        ...
        -- Toggle Diff Preference
        {
          mode = "n",
          key = "<leader>gx",
          handler = "toggle_diff_preference",
          desc = "Toggle diff preference",
        },
      },
      settings = {
